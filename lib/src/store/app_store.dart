...
import 'package:skyfy/src/locale/app_localizations.dart';
...
abstract class AppStoreBase with Store {
  ...
  Future<void> setGoogleUserName({String? name}) async {
    ...
    setValue(userName, googleUserName);
  }
  ...
  Future<void> setGoogleUserEmail({String? email}) async {
    ...
    setValue(userEmail, googleUserEmail);
  }
  ...
  Future<void> setGoogleUserPhotoUrl({String? photoUrl}) async {
    ...
    setValue(userImage, googleUserPhotoUrl);
  }
}
