    ...
    child: TextFormField(
      ...
      decoration: InputDecoration(
        ...
        enabledBorder: OutlineInputBorder(
            ...
            borderSide:
                const BorderSide(color: t1EditTextBackground, width: 0.0)),
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(40),
          borderSide: const BorderSide(color: t1EditTextBackground, width: 0.0),
        ),
      ),
    ),
  );
...
Text formLink(var label) {
  return Text(label,
      style: const TextStyle(color: t1Blue, fontSize: 18),
      textAlign: TextAlign.center);
}
...
Text profile(var label) {
  return Text(label,
      style: const TextStyle(
          color: t1ColorPrimary, fontSize: 18, fontFamily: 'Medium'),
      textAlign: TextAlign.center);
}

//-------------------------------------------View-------------------------------------------------------------------------
Divider view() {
  return const Divider(color: t1ViewColor, height: 0.5);
}
//-----------------------------------------------List------------------------------------------------------------
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
      style: ElevatedButton.styleFrom(
        textStyle: const TextStyle(color: t1White),
        elevation: 4,
        shape:
      ...
      child: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
              colors: <Color>[t1ColorPrimary, t1ColorPrimaryDark]),
    ...
    children: <Widget>[
      Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(width: 16.0, color: t1ColorPrimary),
        ),
      ),
