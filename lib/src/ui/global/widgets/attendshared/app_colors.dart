...
class AppColors {
  ...
  Color btnColor = const Color(0xFFB23EFF);
  Color blurBtnColor = const Color(0xFF413351);

  Color lightColor = const Color(0xFF2F2644);
  Color mediumGrayColor = const Color(0xFF9793A2);
  Color mediumLightColor = const Color(0xFF888CAC);
  Color lightPinkColor = const Color(0xFFFF92C2);
  ...
  Color chatReceiverContainerColor = const Color(0xFFE6E6E6);
  Color chatReceiverTextColor = const Color(0xFF392F51);
  Color appDarkColor = const Color(0xFFFFFFFF);
  Color appMediumColor = const Color(0xFFF6F6F6);
  Color appLightColor = const Color(0xFFFFFFFF);

  Color iconColor = const Color(0xFF302745);

  Color dividerColor = const Color(0xFFC3C5CF);
  Color switchColor = const Color(0xFFA927FF);
  Color switchToggleColor = const Color(0xFFFFFFFF);
